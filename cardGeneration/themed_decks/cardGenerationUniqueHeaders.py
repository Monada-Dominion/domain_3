...
class GlassBeadsCardGenerator:
    ...
    def generate_card(self, name, description, image_path, output_path):
        try:
            ...
            header_font_size = 32
            header_font = ImageFont.truetype("/Fonts/PressStart2P-Regular.ttf", size=header_font_size)
            ...
            name_font = ImageFont.truetype("/Fonts/PressStart2P-Regular.ttf", size=name_font_size)
            description_font = ImageFont.truetype("/Fonts/PressStart2P-Regular.ttf", size=description_font_size)
...
if __name__ == "__main__":
    ...
    names_file = "/namesAndDescriptions/asmlUniversalNames.txt"
    descriptions_file = "/namesAndDescriptions/asmlUniversalDescriptions.txt"
